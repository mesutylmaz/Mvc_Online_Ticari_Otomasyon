...
namespace MVC_Ticari_Otomasyon.Controllers
{
    public class FaturaController : Controller
    {
        ...
        public ActionResult FaturaKalemiEkle(FaturaKalem faturaKalem)
        {
            ...
            fat.FaturaKalemi = faturaKalem.FaturaKalemi;
        ...
        public ActionResult DinamikFaturalar()
        {
            ...
            //ViewBag.dgr1 = context.Personeller.Select(x => x.PersonelAdi + " " + x.PersonelSoyadi).ToList(); ;
            ViewBag.dgr1 = deger1;
            ...
            List<SelectListItem> deger3 = (from x in context.FaturaKalemleri.ToList()
                                           select new SelectListItem
                                           {
                                               Text = x.FaturaKalemi,
                                               Value = x.FaturaKalemID.ToString()
                                           }).ToList();
            ViewBag.dgr3 = deger3;


            List<SelectListItem> deger4 = (from x in context.Urunler.ToList()
                                           select new SelectListItem
                                           {
                                               Text = x.UrunSatisFiyati.ToString(),
                                               Value = x.UrunID.ToString()
            ...
            List<SelectListItem> deger5 = (from x in context.Urunler.ToList()
                                           select new SelectListItem
                                           {
                                               Text = x.UrunAdi,
                                               Value = x.UrunID.ToString()
            ...
            Random rnd = new Random();
            string[] karakterler = { "H", "I", "J", "K", "L", "M", "N" };
            ...
            //dinamikFatura.deger3 = context.Personeller.ToList();
            //dinamikFatura.deger4 = context.Cariler.ToList();
            //dinamikFatura.deger5 = context.Urunler.ToList();
